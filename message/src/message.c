...
{
    memcpy(buffer + SRC_MAC_POS, msg->src_mac, MAC_LEN);
    memcpy(buffer + ORIGINAL_SRC_MAC_POS, msg->original_src_mac, MAC_LEN);
    memcpy(buffer + DST_MAC_POS, msg->dst_mac, MAC_LEN);
